...
\subsubsection{Phenomenological noise model}
...
In the \textit{phenomenological noise model},
...
In a phenomenological noise model, the measurement bias is defined as
...
\subsubsection{Circuit-level noise model}

A \textit{circuit-level noise model} is more fine-grained than a phenomenological noise model.
In a circuit-level noise model,
...
The single-qubit measurement circuits are simulated with two different circuit-level noise models: \textit{standard depolarizing} (SD) and \textit{superconducting-inspired} (SI).
...
The two-qubit measurement circuits are simulated with a different circuit-level noise model referred to as \textit{entangling measurements} (EM) noise.
...
\begin{figure}[htpb]
    ...
    \caption{
        ...
        \href{https://tinyurl.com/bdd7er9s}{The spacelike} and 
        \href{https://tinyurl.com/ypwn6hca}{the timelike} logical errors in
