...
Consider such a logical error in the unrepeated DCCC, consisting of measurement errors on a set of edge operators $\{\dcccOp{e}{\kappa}{P}\}$ all occuring at the timestep $t$.
