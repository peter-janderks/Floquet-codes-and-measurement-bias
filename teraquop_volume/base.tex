...
It could be the case that for different codes the probability of each type of logical error occurring depends exponentially on one parameter and polynomially on the other two, but we have not observed this in any of the DCCCs we have studied.
