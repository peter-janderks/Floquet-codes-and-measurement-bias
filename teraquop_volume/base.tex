...
\begin{figure}[p]
  ...
  \includegraphics[width=0.9\linewidth]{figures/teraquop_volume/X1Y1Z1_X1Z1_teraquop_linefits}
    \caption{
        Plots showing line-fits to determine the minimal value of $n_E$, $n_M$  $h_E,$ and $h_M$ such that the probability of any logical error occuring is $10^{-12}$.
...
It could be the case that for different codes the probablity of each type of logical error occuring depends exponentially on one parameter and polynomially on the other two, but we have not observed this in any of the DCCCs we have studied.
...
Therefore, the logical qubits should be encoded in a circuit with low teraquop \emph{footprint}, and not necesarrilly low teraqoup \emph{volume}.
