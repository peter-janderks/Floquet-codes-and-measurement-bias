...
We begin by considering the simpler case of phenomenological noise -- the simplicity here allows us to look closely at specific error mechanisms in order to better understand the two codes -- before we move to the more realistic but messier case of circuit-level noise.
...
\subsection{Phenomenological noise results}\label{subsec:unrepetaed-phenomenological-noise}

Now we look at our simulation results.
\Cref{fig:X1Y1Z1_X1Z1_comparison} shows $\tilde{n}_E, \tilde{n}_M, \tilde{h}_E, \tilde{h}_M$ and the teraquop volume of the $X^1Y^1Z^1$ and $X^1Z^1$ codes for unbiased, $Z$-biased, and measurement-biased phenomenological noise.
...
\renewcommand*{\arraystretch}{1.5}
    ...
    %    \begin{tabular}{|c|c|c|c|c|c|c|}
            ...
            \cline{2-7}
            & \makecell{Phenom.\\ noise} & \makecell{Meas.\\ noise} & Z noise & \makecell{Phenom.\\ noise} & \makecell{Meas.\\ noise} & Z noise \\
            \cline{2-7}
            \hline
            \hline
...
\subsection{Circuit-level noise results}\label{subsec:unrepeated-circuit-level-noise}

\Cref{fig:X1Y1Z1_X1Z1_comparison_cln} presents $\tilde{n}_E, \tilde{n}_M, \tilde{h}_E, \tilde{h}_M$, and the teraquop volume for the $X^1Y^1Z^1$ and $X^1Z^1$ codes under three circuit-level noise models.
...
Despite simulating entangling measurement noise with a physical error rate ten times higher, the teraquop volumes remain of the same order of magnitude across all three circuit-level noise models.
